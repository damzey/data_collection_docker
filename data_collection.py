...
#I shall create new methods that group together various method
    ...
    def create_folder_get_json_file_and_download_image(self):
        ...
        self.__save__each_anime_dictionary_to_json(self.dict_for_anime,'id_{}/{}.json'.format(self.title_no_space, self.title_no_space))
        self.__download_image(self.image_link, 'id_{}/23112022_152410_1.jpg'.format(self.title_no_space)) 
